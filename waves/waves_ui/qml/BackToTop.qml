    ...
    Rectangle {
        ...
        Row {
            ...
            Text {
                ...
                color: btt.accent; font.family: btt.mono; font.pixelSize: 9; font.bold: true; font.letterSpacing: -1
                Timer { running: btt.on; interval: 120; repeat: true; onTriggered: bttCrest.ph = (bttCrest.ph + 1) % 16 }
            }
            Text {
                textFormat: Text.PlainText; text: "TOP"
                anchors.verticalCenter: parent.verticalCenter
                color: btt.textHi; font.pixelSize: 9; font.bold: true; font.letterSpacing: btt.btnTrack
            }
        }
        MouseArea {
            id: bttMa
