...
// the sections render from the group's own rows, the fold
...
Column {
  ...
  // The head's furniture is the provider's own: "accent"
  ...
  // hover-lit accent head vs Apple's neutral one); the error furniture
  // is the shipped Apple one.
  Item {
    id: groupHead
