"""Guards against the silent wrongs this path can repeat forever.

Silent means no crash and no error, just wrong behaviour repeating: each test
states the user-visible sequence it prevents.
