...
def test_the_handlers_behind_the_keyboard_paths_exist():
    ...
    # The download control, the queue drawer, the shared action button and
    # the gate action live in their own files since #315; the pins span the
    # whole primary-control surface, so read all five.
