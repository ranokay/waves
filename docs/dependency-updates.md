...
| Nuitka           | `pyproject.toml` (`==2.8.4`, exact)                                  | Deliberately, per release                   | Evaluated 2026-09-18 against 4.2.1: kept, because a bump invalidates the release build cache and needs a verified packaged artifact on the release matrix (`R-33`); revisit there. |
